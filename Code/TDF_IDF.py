...
import pandas as pd
df=pd.read_excel('/Users/samas/Desktop/Exxon_Mobil_Data/xlsx/Final_OTMeta_With_Rules.xlsm',sheet_name='MetaData',usecols=[3,7,9,10,11], header=[0])
df=df.dropna()
...
df.to_csv('/Users/samas/Desktop/labelencoder.csv')
...
import os as os
import pickle 
df = pd.read_csv("/Users/samas/Desktop/labelencoder.csv", encoding = "ISO-8859-1")
df["content"] = ""
del df['Unnamed: 0']
df.head()
...
for i, row in df.iterrows():
    data = None
    if os.path.isfile('/Users/samas/Desktop/Exxon_Mobil_Data/text_files/TXTs/' + df.at[i, 'FileName']) :
        with open('/Users/samas/Desktop/Exxon_Mobil_Data/text_files/TXTs/' + df.at[i, 'FileName'], 'r') as myfile:
...
train, test = train_test_split(df, random_state=42, test_size=0.40, shuffle=True)
...
for category in categories:
        print('... Processing {}'.format(category))
        filename='/Users/samas/Desktop/PKL_FILES/'+category+'.pkl'
